...
describe('stock ocr parse', function () {
    it('should return stock history instance.', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    filePath = './data/stock_ocr.txt';
                    return [4 /*yield*/, fs_1.default.promises.readFile(filePath, 'utf8')];
                case 1:
                    fileRaw = _c.sent();
                    expectedStockHistoryPath = './data/stock_history.json';
                    _b = (_a = JSON).parse;
                    return [4 /*yield*/, fs_1.default.promises.readFile(expectedStockHistoryPath, 'utf8')];
                case 2:
                    expectedStockHistory = _b.apply(_a, [_c.sent()]);
                    return [4 /*yield*/, stock_1.parseOCR(fileRaw)];
                case 3:
